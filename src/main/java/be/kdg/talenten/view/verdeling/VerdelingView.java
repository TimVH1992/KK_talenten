...
public class VerdelingView extends BorderPane {
    ...
    private void layoutNodes() {
        ...
        HBox klasSelectieBalk = new HBox(
                12,
                new Label("Klas:"),
                klasComboBox
        );
        ...
        Label klasUitleg = new Label(
                "Dit overzicht toont alle leerlingen van de geselecteerde klas, "
                        + "ook wanneer ze nog niet zijn toegewezen."
        );

        klasUitleg.getStyleClass().add("muted-label");
        klasUitleg.setWrapText(true);

        VBox klasPaneel = new VBox(
                12,
                klasSelectieBalk,
                klasUitleg,
                klasLeerlingenTable
        ...
        Label nietToegewezenUitleg = new Label(
                "Deze leerlingen hebben voor de geselecteerde periode nog geen toewijzing. "
                        + "Selecteer een leerling om diens voorkeuren te bekijken en "
                        + "de leerling manueel toe te wijzen."
        );

        nietToegewezenUitleg.getStyleClass().add("muted-label");
        nietToegewezenUitleg.setWrapText(true);

        VBox nietToegewezenPaneel = new VBox(
                12,
        ...
        Label uitleg = new Label(
                "Selecteer een leerling in een van de tabellen en kies daarna "
        ...
        VBox voorkeurenPaneel = maakDetailPaneel(
                voorkeurenTitelLabel,
                voorkeurenTable
        );

        VBox historiekPaneel = maakDetailPaneel(
                historiekTitel,
                historiekTable
        );

        VBox wijzigingPaneel = new VBox(
                10,
                handmatigeTitel,
                uitleg,
                doelTalentComboBox,
