...
public class VoorkeurenView extends BorderPane {
    ...
    private void layoutNodes() {
        setLeft(maakSidebar());
        setCenter(maakScrollbareInhoud());
    ...
    private ScrollPane maakScrollbareInhoud() {
        VBox inhoud = maakInhoud();
    ...
    private VBox maakInhoud() {
        ...
        VBox inhoud = new VBox(18, header, statusLabel, selectieCard, acties, problemenCard);
