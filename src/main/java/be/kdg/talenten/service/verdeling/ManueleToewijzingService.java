...
public class ManueleToewijzingService {
    ...
    public ManueleToewijzingService(
        ...
        if (voorkeurRepository == null) {
            throw new IllegalArgumentException(
                    "VoorkeurRepository mag niet null zijn"
            );
        }
    ...
    public Toewijzing wijzigToewijzing(
        ...
        if (nieuwIngerichtTalent == null) {
            throw new IllegalArgumentException(
                    "Nieuw ingericht talent mag niet null zijn."
            );
        }
        ...
        if (talentenPeriode
            ...
            throw new IllegalStateException(
                    "Een afgelopen talentenperiode mag niet meer gewijzigd worden."
            );
        }

        if (!nieuwIngerichtTalent
                .getTalentenPeriode()
                .equals(talentenPeriode)) {

            throw new IllegalArgumentException(
                    "Het ingericht talent behoort niet tot deze talentenperiode."
            );
        }

        if (!nieuwIngerichtTalent
                .isGeschiktVoor(leerling)) {
        ...
        if (bestaandeToewijzing == null) {
            ...
            return toewijzingRepository.save(
                    nieuweToewijzing
            );
        }
        ...
        return toewijzingRepository.update(
                bestaandeToewijzing
        );
    }
    ...
    private Integer bepaalVoorkeurNummer(
        ...
        List<Voorkeur> voorkeurenVoorLeerling =
                voorkeurRepository
        ...
        for (Voorkeur voorkeur :
                voorkeurenVoorLeerling) {

            if (voorkeur
                    .getIngerichtTalent()
                    .equals(gekozenTalent)) {
